...
def add_hooks(app):
    ...
    app.on_fetched_item_regions_notifications += _add_links_to_notification
    app.on_fetched_resource_regions_notifications += _add_links_to_notifications_collection
    app.on_post_POST_regions_notifications += _post_notifications
...
def _add_links_to_notification(notification):
    ...
    if notification.get('_region_ref'):
        notification['_links']['parent'] = {
            'href': f'{base_url}/regions/{notification["_region_ref"]}',
            'title': 'regions'
        }
        notification['_links']['collection'] = {
            'href': f'{base_url}/regions/{notification["_region_ref"]}/notifications',
