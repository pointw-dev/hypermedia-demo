...
def add_hooks(app):
    ...
    app.on_fetched_item_regions_catalogs += _add_links_to_catalog
    app.on_fetched_resource_regions_catalogs += _add_links_to_catalogs_collection
    app.on_post_POST_regions_catalogs += _post_catalogs
...
def _add_links_to_catalog(catalog):
    ...
    if catalog.get('_region_ref'):
        catalog['_links']['parent'] = {
            'href': f'{base_url}/regions/{catalog["_region_ref"]}',
            'title': 'regions'
        }
        catalog['_links']['collection'] = {
            'href': f'{base_url}/regions/{catalog["_region_ref"]}/catalogs',
