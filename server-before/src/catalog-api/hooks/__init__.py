...
import hooks.regions
import hooks.brands
import hooks.notifications
import hooks.catalogs
import hooks.families
import hooks.feature_displays
...
def add_hooks(app):
    ...
    hooks.regions.add_hooks(app)
    hooks.brands.add_hooks(app)
    hooks.notifications.add_hooks(app)
    hooks.catalogs.add_hooks(app)
    hooks.families.add_hooks(app)
    hooks.feature_displays.add_hooks(app)
