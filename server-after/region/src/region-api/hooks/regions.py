...
def _add_remote_children_links(region):
    ...
    region['_links']['notifications'] = {
        'href': f"{get_href_from_gateway('notifications')}/region/{region_id}",
        'title': 'notifications'
    }
    region['_links']['brands'] = {
        'href': f"{get_href_from_gateway('brands')}/region/{region_id}",
        'title': 'brands'
    }
    region['_links']['catalogs'] = {
        'href': f"{get_href_from_gateway('catalogs')}/region/{region_id}",
        'title': 'catalogs'
    }
