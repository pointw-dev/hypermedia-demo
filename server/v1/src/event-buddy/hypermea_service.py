...
class HypermeaService:
    def __init__(self, **kwargs):
        ...
        self._name = SETTINGS.get('HY_API_NAME', default_value='event-buddy')
        self._app = HypermeaEve(import_name=self._name, auth=HypermeaAuthorization, validator=CustomHypermeaValidator)
        CORS(self._app)
