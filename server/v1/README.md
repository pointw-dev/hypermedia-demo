...
If you are an **API developer** who will make changes to `event-buddy` itself, please see [`src/event-buddy/README.md`](./src/event-buddy/README.md).
