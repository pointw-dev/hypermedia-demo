...
from hypermea.core.href import get_resource_id, get_my_base_url, url_join
from hypermea.core.gateway import get_href_from_gateway
from hypermea.core.utils import get_db, get_api
...
def _register(registration, username=None):
    ...
    headers = {
        ...
        'Authorization': request.authorization.to_header()
    }

    registration_url = url_join(
        get_href_from_gateway('registration'),
        f'/event/{event_id}'
    )
