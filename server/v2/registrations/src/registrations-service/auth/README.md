...
* Create API
  * Identifier (e.g. https://pointw.com/registrations-service )
...
* If using Authorization Code grant type, pass the audience by query string to the Auth URL
  * e.g. https://registrations-service.us.auth0.com/authorize?audience=https://pointw.com/registrations-service
