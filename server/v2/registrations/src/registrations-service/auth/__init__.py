...
SETTINGS.create('AUTH', {
    ...
    'REALM': 'registrations-service.hypermea.com',
    "CLAIMS_NAMESPACE": "uri://hypermea.com/claims",

    'JWT_DOMAIN': 'registrations-service.us.auth0.com',
    'JWT_ISSUER': 'https://registrations-service.us.auth0.com/',
    'JWT_AUDIENCE': 'uri://hypermea.com/registrations-service'
})
