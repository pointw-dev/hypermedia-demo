...
class HypermeaService:
    def __init__(self, **kwargs):
        ...
        self._name = SETTINGS.get('HY_API_NAME', default_value='registrations-service')
        self._app = HypermeaEve(import_name=self._name, validator=CustomHypermeaValidator, auth=HypermeaAuthorization)
        CORS(self._app)
