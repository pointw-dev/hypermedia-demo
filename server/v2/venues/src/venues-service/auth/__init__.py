...
SETTINGS.create('AUTH', {
    ...
    'REALM': 'venues-service.hypermea.com',
    "CLAIMS_NAMESPACE": "uri://hypermea.com/claims",

    'JWT_DOMAIN': 'venues-service.us.auth0.com',
    'JWT_ISSUER': 'https://venues-service.us.auth0.com/',
    'JWT_AUDIENCE': 'uri://hypermea.com/venues-service'
})
