...
SETTINGS.create('AUTH', {
    ...
    'REALM': 'accounts-service.hypermea.com',
    "CLAIMS_NAMESPACE": "uri://hypermea.com/claims",

    'JWT_DOMAIN': 'accounts-service.us.auth0.com',
    'JWT_ISSUER': 'https://accounts-service.us.auth0.com/',
    'JWT_AUDIENCE': 'uri://hypermea.com/accounts-service'
})
