...
class AuthSettings(BaseSettings):
    ...
    realm: str = Field(
        default='registration-service.hypermea.com',
    ...
    claims_namespace: str = Field(
        default='uri://hypermea.com/registration-service/claims',
        description='The namespace used for unique claims issued by your auth provider.'
    )
    jwt_domain: str = Field(
        default='registration-service.us.auth0.com'
    )
    jwt_issuer: str = Field(
        default='https://registration-service.us.auth0.com'
    )
    jwt_audience: str = Field(
        default='uri://hypermea.com/registration-service'
    )
