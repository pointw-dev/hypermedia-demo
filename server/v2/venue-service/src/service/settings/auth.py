...
class AuthSettings(BaseSettings):
    ...
    realm: str = Field(
        default='venue-service.hypermea.com',
    ...
    claims_namespace: str = Field(
        default='uri://hypermea.com/venue-service/claims',
        description='The namespace used for unique claims issued by your auth provider.'
    )
    jwt_domain: str = Field(
        default='venue-service.us.auth0.com'
    )
    jwt_issuer: str = Field(
        default='https://venue-service.us.auth0.com'
    )
    jwt_audience: str = Field(
        default='uri://hypermea.com/venue-service'
    )
