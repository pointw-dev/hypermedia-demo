...
SETTINGS.create('AUTH', {
    ...
    'REALM': 'events-service.hypermea.com',
    "CLAIMS_NAMESPACE": "uri://hypermea.com/claims",

    'JWT_DOMAIN': 'events-service.us.auth0.com',
    'JWT_ISSUER': 'https://events-service.us.auth0.com/',
    'JWT_AUDIENCE': 'uri://hypermea.com/events-service'
})
